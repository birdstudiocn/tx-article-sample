 ...
 * 
 */
public class JmsTransactionAwareDataSourceProxy extends
		TransactionAwareDataSourceProxy {

	private static final Log logger = LogFactory
			.getLog(JmsTransactionAwareDataSourceProxy.class);

	private static final String RESOURCE_KEY = JmsTransactionAwareDataSourceProxy.class
			.getName() + ".JMS_SYNCHRONIZATION";
	...
	private class TransactionAwareInvocationHandler implements
		...
		public Object invoke(Object proxy, Method method, Object[] args)
			...
			if (method.getName().equals("equals")) {
				...
				// transaction.
				if (DataSourceUtils.isConnectionTransactional(this.target,
						this.targetDataSource)) {
					return null;
				}
	...
	private void maybeRegisterSynchronization() {
		...
		TransactionSynchronizationManager.bindResource(RESOURCE_KEY,
				Boolean.TRUE);
							...
							public Object doInJms(final Session session)
								...
								try {
									...
									throw new SynchedLocalTransactionFailedException(
											"Failed to commit JMS Session in shared resource synchronization.",
											e);
								}
								return null;
							}
