 ...
 * down. Us as a bean definition <br/>
 * <br/>
 * 
 * Run this class to initialize a database in a running server process. Make
 * sure the server is running first by launching the "hsql-server" from the
 * <code>hsql.server</code> project. Then you can right click in Eclipse and Run
 * As -&gt; Java Application. Do the same any time you want to wipe the database
 * and start again.
 * 
 * @author Dave Syer
 * 
	...
	public static void main(String... args) {
		new ClassPathXmlApplicationContext(
				ClassUtils.addResourcePathToPackagePath(
						...
						DataSourceInitializer.class.getSimpleName()
								+ "-context.xml"));
	}
